...
class OrderController extends Controller
{
    ...
    {
        #get credit card information send to bank webservice if everything is okey next.
        $data = new Order;
        ...
        return redirect()->route('user_orders')->with('Success','Product Added Successfully');
    }
